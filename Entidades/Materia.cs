...
namespace Entidades
{
    public class Materia
    {
        ...
        public Materia(int idMateria, String nombreMateria, String descripcionMateria, String usuarioCreacion, DateTime fechaCreacion, String usuarioModificacion, DateTime fechaModificacion, String estadoMateria, int numeroHorasMaterias, Area area, Grado grado)
        {
