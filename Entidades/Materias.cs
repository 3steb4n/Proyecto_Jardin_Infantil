...
namespace Entidades
{
    public class Materias
    {
        ...
        public Materias(int idMateria, String nombreMateria, String descripcionMateria, String usuarioCreacion, DateTime fechaCreacion, String usuarioModificacion, DateTime fechaModificacion, String estadoMateria, int numeroHorasMaterias, Area area, Grado grado)
        {
